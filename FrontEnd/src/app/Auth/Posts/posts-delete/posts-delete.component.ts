...
export class PostsDeleteComponent implements OnInit {
  ...
  RemovePost(DeletePost: NgForm){

    if(DeletePost.invalid){
      ...
      if(DeletePost.value.IdOfPostToBeRemoved != null ||DeletePost.value.IdOfPostToBeRemoved !=""){
        ...
        this.PostsService.DeletePostService(DeletePost.value.IdOfPostToBeRemoved)
        //This programming statement was adapted from C# Corner:
