...
@Component({
  ...
  styleUrls: ['./posts-get.component.scss']
})
export class PostsGetComponent implements OnInit {
  ...
  GetPosts(GetPost: NgForm){
    ...
    if(GetPost.invalid){
      ...
      if(GetPost.value.ProvidedPostTitle != "" || GetPost.value.ProvidedPostTitle != null){
        ...
        this.PostsService.GetPostsService(GetPost.value.ProvidedPostTitle)
